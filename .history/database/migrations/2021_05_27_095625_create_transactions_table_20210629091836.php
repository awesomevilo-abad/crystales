...
class CreateTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->json('po_group')->nullable();
            $table->json('referrence_group')->nullable();
            ...
            $table->float('pcf_date');
            $table->string('pcf_letter');
            $table->float('utilities_from');
            $table->float('utilities_to');
