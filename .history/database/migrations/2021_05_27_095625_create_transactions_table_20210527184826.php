...
class CreateTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->bigInteger('transaction_id')->unsigned()->unique()->nullable();
            $table->bigInteger('tag_id')->unsigned()->unique()->nullable();
            ...
            $table->bigInteger('referrence_id')->unsigned()->unique()->nullable();
