...
// REASON
Route::resource('reasons', CompanyController::class);
Route::post('reasons/archive/{id}', [CompanyController::class, 'archive']);
Route::post('reasons/search/', [CompanyController::class, 'search']);
