...
// ARCHIEVE
Route::resource('referrences', SupplierController::class);
Route::post('referrences/archive/{id}', [SupplierController::class, 'archive']);
Route::post('referrences/search/', [SupplierController::class, 'search']);
// });
