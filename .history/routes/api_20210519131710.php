...
// BANK
Route::resource('banks', ReasonController::class);
Route::post('banks/archive/{id}', [ReasonController::class, 'archive']);
Route::post('banks/search/', [ReasonController::class, 'search']);
