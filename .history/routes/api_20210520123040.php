...
// REFERRENCE
Route::resource('supplier-types', ReferrenceController::class);
Route::post('supplier-types/archive/{id}', [ReferrenceController::class, 'archive']);
Route::post('supplier-types/search/', [ReferrenceController::class, 'search']);

// SUPPLIER
Route::resource('supplier-types', SupplierController::class);
Route::post('supplier-types/archive/{id}', [SupplierController::class, 'archive']);
Route::post('supplier-types/search/', [SupplierController::class, 'search']);
// });
