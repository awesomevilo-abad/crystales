...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $user_document_category_document_ids =  DB::table('user_document_category')->where('category_id',0)->get();
        ...
        foreach($user_document_category_document_ids as $specific_user_document_category_document_id){
            ...
            return $specific_user_document_category_document_id['document_id']

        }
        return $user_document_category_document_ids;
