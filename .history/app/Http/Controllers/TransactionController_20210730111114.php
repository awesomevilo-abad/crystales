...
class TransactionController extends Controller
{
    ...
    public function status_group(Request $request)
    {
        ...
        $status_group = DB::select(DB::raw("SELECT
        ...
        transactions.po_total_amount,


        transactions.id,
        transactions.user_id,
        transactions.id_prefix,
        transactions.id_no,
        ...
        transactions.po_total_qty,
        transactions.rr_total_qty,


        transactions.referrence_total_amount,
        transactions.referrence_total_qty,
        transactions.date_requested,
        transactions.remarks,
        transactions.payment_type,
        transactions.status,
        transactions.reason_id,
        transactions.reason,
        ...
        FROM `transactions`
        LEFT JOIN p_o_batches on transactions.tag_id = 
