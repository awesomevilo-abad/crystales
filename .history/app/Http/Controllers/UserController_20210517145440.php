...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        foreach ($result as $document_category_details) {
            $document_types = $document_category_details->document_types;
            foreach ($document_types as $document_type_details) {
                print_r($categories = $document_type_details['categories']);
