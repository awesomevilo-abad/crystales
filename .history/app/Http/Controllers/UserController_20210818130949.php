...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $user_document_category_document_ids =  DB::table('user_document_category')->where('user_id',$id)->get();

        foreach($user_document_category_document_ids as $specific_user_document_category_document_id){
            $specific_user_document_category_document_ids[] =  $specific_user_document_category_document_id->document_id;
        }
        $registered_document_ids = array_unique($specific_user_document_category_document_ids);
        $registered_document_ids =  array_values($registered_document_ids);

        $differenceArray = array_diff($registered_document_ids, $inputted_document_types);
        print_r($registered_document_ids) ;

                        $fullDiff = array_merge(array_diff($registered_document_ids, $inputted_document_types), array_diff($inputted_document_types, $registered_document_ids));
