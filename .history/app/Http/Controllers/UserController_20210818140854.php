...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $additional_document_id = array_merge(array_diff($registered_document_ids, $inputted_document_types), array_diff($inputted_document_types, $registered_document_ids));
        if(isset($additional_document_id))
