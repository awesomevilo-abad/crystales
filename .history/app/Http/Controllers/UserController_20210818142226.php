...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $inputted_document_types= array();
        $specific_get_document_ids= array();
        $document_types =  $request['document_types'];
        foreach($document_types as $specific_document_type){
            array_push($inputted_document_types ,  $specific_document_type['document_id']);
        }
        ...
        foreach($get_document_ids as $specific_get_document_ids){
            print_r($specific_get_document_ids->document_id);
            array_push($specific_get_document_ids,$specific_get_document_ids->document_id);
        }
        return $specific_get_document_ids;
