...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $get_document_id =  DB::table('user_document_category')->where('user_id',$id)->get();

        foreach($get_document_id as $specific_user_document_category_document_id){
            $specific_get_document_id[] =  $specific_user_document_category_document_id->document_id;
        }
        $registered_document_ids = array_unique($specific_get_document_id);
