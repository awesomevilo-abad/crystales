        ...
        foreach($transactions as $transaction){
           ...
           foreach($get_referrence as $specific_refference){
              $referrence_group->push([
                ...
                "referrence_no"=>$specific_refference->referrence_type,
                "referrence_amount"=>$specific_refference->referrence_type,
                "referrence_qty"=>$specific_refference->referrence_type
              ]);
           }
