...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach($fields['document_types'] as $specific_document_type){
            ...
            echo $user_id.'_'.$specific_document_type['document_id'].'_'.$specific_document_type['category_id'];
            ...
            //     $category_id = [];
            // }else{
            //     $category_id = ($specific_document_type['category_id']);
            // }

            // $new_user = UserDocumentCategory::create([
            //     'user_id' =>$user_id,
