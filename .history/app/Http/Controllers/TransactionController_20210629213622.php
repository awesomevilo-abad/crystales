...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        //  ->select('t.created_at','t.transaction_id','t.document_type'
        //  ,'t.document_no'
        //  ,'t.document_amount'
        //  ,'t.company'
        //  ,'t.supplier'
        //  ,'t.po_total_amount'
        //  ,'t.referrence_total_amount'
        //  ,'t.payment_type'
        //  ,'t.status'
        //  ,'t.remarks')
        // ->innerJoin('p_o_group_batches as PGB','t.tag_id','=','PGB.tag_id')
        // ->innerJoin('p_o_batches as PB','PGB.po_no','=','PB.po_no')
        // ->innerJoin('referrence_group_batches as RGB','t.tag_id','=','RGB.tag_id')
        // ->innerJoin('referrence_batches as RB','RGB.referrence_no','=','RB.referrence_no')
        // ->get();
        ...
        foreach($transactions as $transaction){
            ...
            $get_PO_Group_Batch = DB::table('p_o_group_batches as PGB')
            ->select('PGB.tag_id','PGB.po_no')
            ->join('p_o_batches as PB','PGB.po_no','=','PB.po_no')
            ->where('PGB.tag_id',$transaction->tag_id)
            ->groupBy(['tag_id','po_no']);
            ->get();

            return ($get_PO_Group_Batch) ;
