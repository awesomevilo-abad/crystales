...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->select('documents.id',
        'categories.id',
        'user_document_category.user_id',
        'user_document_category.document_id',
        'user_document_category.category_id')
        ->leftJoin('document_categories','documents.id','=','document_categories.document_id')
        ->leftJoin('categories','document_categories.category_id','=','categories.id')
        ->leftJoin('user_document_category','document_categories.document_id','=','user_document_category.document_id')
        ->on('document_categories.document_id','=','user_document_category.document_id')

        // ->leftJoin('user_document_category', function($query){
        //     $query->on('user_document_category.document_id','=','document_categories.document_id')
        //         ->where('user_document_category.category_id','=','document_categories.category_id');
        // })

        ->leftJoin('users','user_document_category.user_id','=','users.id')
