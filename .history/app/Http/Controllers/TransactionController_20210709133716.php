...
class TransactionController extends Controller
{
    ...
    public function store(TransactionPostRequest $request)
    {
        ...
        if (GenericMethod::countTableById('documents',$fields['document_id']) < 1) {
            ...
            else if(($fields['document_id'] == 5 || $fields['document_type'] == "Receipt")){
                $response =  "Receipt TRANSACTION HERE";
            }
            else if(($fields['document_id'] == 6 || $fields['document_type'] == "Payroll")){
                $response =  "Payroll TRANSACTION HERE";
            }
            else if(($fields['document_id'] == 8 || $fields['document_type'] == "PCF")){
                $response =  "Payroll TRANSACTION HERE";
            }
            else if(($fields['document_id'] == 9 || $fields['document_type'] == "Utilities")){
                $response =  "Payroll TRANSACTION HERE";
            }
            else{
                $response = [
