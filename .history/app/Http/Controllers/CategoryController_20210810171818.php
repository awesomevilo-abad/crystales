...
class CategoryController extends Controller
{
    ...
    public function archive(Request $request, $id)
    {
        // UPDATE CATEGORY
        $specific_category = Category::find($id);
        $specific_user_document_category = UserDocumentCategory::where('category_id','=',$id);
        return $specific_user_document_category;
        ...
        $specific_user_document_category->is_active = 0;
        $specific_category->save();
