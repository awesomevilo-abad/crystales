...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->leftJoin('user_document_category', function($query){
            $query->on('user_document_category.document_id','=','user_document_category.document_id')
                ->where('document_categories.category_id','=','user_document_category.category_id');
        })
