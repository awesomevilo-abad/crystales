            ...
            if($specific_document_details->masterlist_document_id == $specific_document_details->user_document_id){
                ...
                foreach($categories as $specific_categories){
                    if($specific_categories['document_id'] == $specific_document_details->user_document_id){
                        ...
                        $categories_per_doc->push([
                            "category_id"=>$specific_categoriescategory_id,
                            "category_name"=>$specific_categoriescategory_name,
                            "category_status"=>$specific_categoriescategory_status,
                        ]);
                    }else{
                        $categories_per_doc = [];
                    }
