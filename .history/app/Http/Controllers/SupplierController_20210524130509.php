...
class SupplierController extends Controller
{
    ...
    public function supplier(Request $request, $id)
    {
        ...
        $specific_supplier->supplier_type = $request->get('supplier_type');
        $specific_supplier->supplier_description = $request->get('supplier_description');

        $category_ids = $request['categories'];
        $specific_supplier->categories()->detach();
        $specific_supplier->categories()->attach($category_ids);

        $specific_supplier->save();

        return [
            'success_message' => 'Succesfully supplierd!',
        ];
    }
