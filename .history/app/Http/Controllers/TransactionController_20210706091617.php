...
class TransactionController extends Controller
{
    ...
    {
        echo $request->referrence_group[0]['referrence_type'];
        ...
        //         "data" => null,
        //     ];
        // } elseif ($this->referrenceCount($fields['referrence_no']) < 1) {
        //     $response = [
        //         "code" => 404,
        //         "message" => "Referrence no is not registered on the masterlist",
        //         "data" => null,
        //     ];
        // } elseif ($this->reasonCount($fields['reason_id']) < 1) {
        //     $response = [
        //         "code" => 404,
        //         "message" => "Reason ID is not registered on the masterlist",
        //         "data" => null,
        //     ];
