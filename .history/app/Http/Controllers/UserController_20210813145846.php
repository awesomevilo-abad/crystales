...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        FROM documents
        RIGHT JOIN document_categories
        ...
        foreach($document_details as $specific_document_details){
            ...
            $categories->push([
                ...
                "masterlist_document_id"=>$specific_document_details->masterlist_document_id,
                "document_id"=>$specific_document_details->user_document_id,
                "masterlist_category_id"=>$specific_document_details->masterlist_category_id,
                "category_id"=>$specific_document_details->user_category_id,
        ...
        $final_document_details_with_category = GenericMethod::unique_values_in_array_based_on_key($document_details,'masterlist_document_id');

        // return $document_details;
        foreach($final_document_details_with_category as $final_specific_document_details_with_category ){

            print_r($final_specific_document_details_with_category);
            // echo $final_specific_document_details_with_category ->masterlist_document_id.'=='.$final_specific_document_details_with_category ->user_document_id.'________';

            // if($final_specific_document_details_with_category ->masterlist_document_id == $final_specific_document_details_with_category ->user_document_id){
            //     $document_status = true;
            //     foreach($categories as $specific_categories){
            //         if($specific_categories['document_id'] == $final_specific_document_details_with_category ->user_document_id){
            ...
            // $document_types->push([
            //     "document_id"=>$final_specific_document_details_with_category ->masterlist_document_id,
            //     "document_name"=>$final_specific_document_details_with_category ->document_name,
            //     "document_status"=>$document_status,
