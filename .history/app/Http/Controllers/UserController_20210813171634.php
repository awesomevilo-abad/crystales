            ...
            // if($final_specific_document_details->masterlist_document_id == $final_specific_document_details->user_document_id){
                ...
                foreach($categories as $specific_categories){
                    ...
                    if($specific_categories['document_id'] == $final_specific_document_details->user_document_id){
                        ...
                        // echo $specific_categories['document_id'] .'=='. $final_specific_document_details->masterlist_document_id.'____';
                        array_push($categories_per_doc, array(
                            "user_document_id"=>$specific_categories['user_document_id'],
                            "user_category_id"=>$specific_categories['user_category_id'],
                            "document_id"=>$specific_categories['document_id'],
                    ...
                    }else if($specific_categories['document_id'] == $final_specific_document_details->masterlist_document_id){
