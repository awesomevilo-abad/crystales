...
class UserController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $result = User::where('id_prefix', 'like', '%' . $value . '%')
            ->were('id_no', 'like', '%' . $value . '%')
            ->were('first_name', 'like', '%' . $value . '%')
            ->were('middle_name', 'like', '%' . $value . '%')
            ->were('last_name', 'like', '%' . $value . '%')
            ->were('suffix', 'like', '%' . $value . '%')
            ->were('department', 'like', '%' . $value . '%')
            ->were('position', 'like', '%' . $value . '%')
            ->were('permissions', 'like', '%' . $value . '%')
            ->were('document_types', 'like', '%' . $value . '%')
            ->were('categories', 'like', '%' . $value . '%')
            ->were('username', 'like', '%' . $value . '%')
            ->were('is_active', 'like', '%' . $value . '%')
            ->get();
