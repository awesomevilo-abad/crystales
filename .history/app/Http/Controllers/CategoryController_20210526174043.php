...
class CategoryController extends Controller
{
    ...
    public function archive(Request $request, $id)
    {
        ...
        foreach ($users as $specific_user) {
            ...
            // echo $specific_user->document_types;
            $document_types = json_decode($specific_user->document_types, true);
            //     // Search

            foreach ($document_types as $specific_document_type) {
                $specific_document_type['categories'];
                ...
                // return $specific_document_type['categories'];
            }
