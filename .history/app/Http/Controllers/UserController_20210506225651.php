...
class UserController extends Controller
{
    ...
    public function search(Request $request, $value)
    {
        ...
        $result = DB::table('users')
            ->where('id_prefix', $value)
            ->orWhere('id_no', $fields['id_no'])
            ->orWhere('role', $fields['role'])
            ->orWhere('first_name', $fields['first_name'])
            ->orWhere('middle_name', $fields['middle_name'])
            ->orWhere('last_name', $fields['last_name'])
            ->orWhere('suffix', $fields['suffix'])
            ->orWhere('department', $fields['department'])
            ->orWhere('position', $fields['position'])
            ->orWhere('permissions', $fields['permissions'])
            ->orWhere('document_types', $fields['document_types'])
            ->orWhere('categories', $fields['categories'])
            ->orWhere('username', $fields['username'])
            ->get();
