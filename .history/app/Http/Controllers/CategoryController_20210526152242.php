...
class CategoryController extends Controller
{
    ...
    public function archive(Request $request, $id)
    {
        ...
        foreach ($users as $specific_user) {
            ...
            foreach (range(count($specific_document_types->categories)) as $i) {

                // echo (count($specific_document_types->categories));

                // $untag_id_position = array_search($id, $document_types);

                // // Remove from array
                // unset($document_types[$untag_id_position]);
                // dd($document_types);
