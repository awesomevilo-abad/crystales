    ...
    public function update(Request $request, $id)
    {
        ...
        if(isset($additional_document_ids)){
            ...
            foreach($additional_document_ids as  $specific_additional_document_id){
                ...
                return ($new_categories->push();
                $new_document_ids->push([
                    "document_id"=> $specific_additional_document_id,
                ]);

                $new_document_type = $new_document_ids->merge($new_categories);
