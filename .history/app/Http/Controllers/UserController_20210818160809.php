...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach($inputted_document_types as $specific_inputted_document_types){
            foreach($registered_document_ids as $specific_registered_document_ids){
                if ($specific_inputted_document_types == $specific_registered_document_ids){
                    echo $specific_inputted_document_types.' ay may laman';
                }else{
                    echo $specific_inputted_document_types.' ay existing';
                }
            }
        }
