...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($document_ids as $specific_doc_id) {
            ...
            array_push($created_document_categories, array("document_types" => array("document_id" => $specific_doc_id, "categories" => $categories)));
            array_replace($created_document_categories, $document);
        }
