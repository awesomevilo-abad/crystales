...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach($user_document_category_document_ids as $specific_user_document_category_document_ids){
            $specific_user_document_category_document_ids[] =  $specific_document_type['document_id'];
        }
