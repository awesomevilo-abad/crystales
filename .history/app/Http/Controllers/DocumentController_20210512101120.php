    ...
    public function index()
    {
        ...
        foreach ($document_ids as $doc_id) {
            $result = DB::table('documents AS d')
                ...
                $document_type = $result->pluck('document_type');
                $document_description = $result->pluck('document_description');
                $dis_active = $result->pluck('dis_active');
                $document_description = $result->pluck('categories');

            $category_ids->push(['doc_id' => $doc_id,'document_type' => $doc_id, 'cat_id' => $result->pluck('categories')]);
