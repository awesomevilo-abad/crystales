...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach($registered_document_ids as $specific_document_id){
            $document_type = GenericMethod::getCategoriesByUserAndDocID($id,$specific_document_id);
            foreach($document_type as $specific_document_type){
                $registered_category_ids[] =$specific_document_type->category_id;
            }
            $document_type = GenericMethod::where($document_types,'document_id',$specific_document_id,'categories');
            $inputted_categories = $document_type['categories'];

            return $registered_category_ids;
            $additional_category_ids = array_merge(array_diff($registered_document_ids, $inputted_document_types), array_diff($inputted_document_types, $registered_document_ids));

            return $inputted_categories;
        }

         return $registered_document_ids;
