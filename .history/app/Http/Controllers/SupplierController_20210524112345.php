    ...
    public function index()
    {
        ...
        foreach ($referrence_ids as $specific_referrence) {
            ...
            $supplier_details = DB::table('suppliers as s')
                ->select('s.supplier_name aASs sname', 's.supplier_code as scode', 's.terms as sterms', 'st.type as sttype', 'st.transaction_days as sttransaction')
                ->where('s.id', $sup_id)
            ...
            $final_supplier_details->push([
                ...
                'transaction_days' => $supplier_details['sttransaction'],
