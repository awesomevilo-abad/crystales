    ...
    public function store(Request $request)
    {
        ...
        foreach ($document_ids as $specific_doc_id) {
            ...
            $created_document_categories->push([
                'document_id' => $specific_doc_id
                , 'category_id' => $categories,
            ]);
        }
        $fields['document_category_details'] =$created_document_categories;
        array_push($document_types_transformed
        return ($created_document_categories);
