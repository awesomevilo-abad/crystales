...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($unregistered_supplier_type_id) {
            ...
            $message = $unregistered_supplier_type_id_compiled . ' is not existing in the referrences table or disabled';
            ...
            if ($unregistered_referrences) {
                ...
                $message = $unregistered_referrence_compiled . ' does not existing in the referrences table or disabled';
                $response = [
                    "code" => 422,
                    "message" => $message,
                    "data" => null,
