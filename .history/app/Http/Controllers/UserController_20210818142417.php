...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach($get_document_ids as $specific_user_document_category_document_id){
            $specific_get_document_ids[] =  $specific_user_document_category_document_id->document_id;
        }
        $registered_document_ids = array_unique($specific_get_document_ids);
