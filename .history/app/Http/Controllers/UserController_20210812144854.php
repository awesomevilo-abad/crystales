...
class UserController extends Controller
{
    ...
    {
        // $result = User::find($id);
        $result = DB::select( DB::raw('SELECT documents.id AS "Masterlist Document ID",
        documents.document_type AS "document_name",
        categories.id AS "Masterlist Category ID",
        categories.name AS "document_name",
        user_document_category.user_id AS "User ID" ,
        user_document_category.document_id AS "User Document ID",
        user_document_category.category_id AS "User Category ID"
        FROM documents
