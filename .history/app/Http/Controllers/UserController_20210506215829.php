...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $duplicate_users = DB::table('users')
            ...
            ->orWhere(function ($query) use ($fields['id_prefix'],$fields['id_prefix']){
        ...
        if ($duplicate_users->count()) {
            throw ValidationException::withMessages([
                'first_name' => ['First Name is Duplicated'],
                'middle_name' => ['Middle Name is Duplicated'],
                'last_name' => ['Last Name is Duplicated'],
                'suffix' => ['Suffix is Duplicated'],
                'id_prefix' => ['ID Prefix is Duplicated'],
                'id_no' => ['ID No is Duplicated'],
