...
class TransactionController extends Controller
{
    ...
    public function store(TransactionPostRequest $request)
    {
        ...
        if (GenericMethod::countTableById('documents',$fields['document_id']) < 1) {
            ...
            if(($fields['document_id'] == 3 || $fields['document_type'] == "PAD")){
                $po = $fields['po_group'];
                $po_count = count($po);
                ...
                for($i=0;$i<$po_validation_count;$i++){
                    ...
                    if (TransactionValidationMethod::validateExistingDocNo($fields['document_type'],$fields['payment_type'],
            ...
            else if(($fields['document_id'] == 7 || $fields['document_type'] == "PRM") && $fields['document_type']  == "FULL"){
                for($i=0;$i<$po_validation_count;$i++){
                    ...
                    if (TransactionValidationMethod::validateExistingPRMTransaction($fields['document_type'],$fields['payment_type'],
