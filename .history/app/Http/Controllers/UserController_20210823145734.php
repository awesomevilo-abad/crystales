...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach($registered_document_ids as $specific_document_id){
            ...
            $additional_category_ids = array_merge(array_diff($registered_category_ids, $inputted_document_types), array_diff($inputted_document_types, $registered_document_ids));
