        ...
        foreach ($referrence_ids as $specific_referrence) {
            ...
            foreach ($supplier_details as $sd) {
                ...
                $final_supplier_details->push([
                    'supplier_name' => $supplier_detailssupplier_name'],
                    'supplier_code' => $supplier_detailssupplier_code'],
                    'terms' => $supplier_detailsterms'],
                    'referrences' => $specific_referrencereferrences'],
