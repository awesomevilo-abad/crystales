...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        categories.name AS "document_name",
        ...
        foreach($document_details as $specific_document_details){
            ...
            if($specific_document_details->masterlist_category_id == $specific_document_details->user_category_id){

            }else{

            }
            $categories->push([
                "category_id"=>$specific_document_details->masterlist_document_id,
                "category_name"=>$specific_document_details->document_name,
                "category_status"=>$document_status,
            ]);
