...
class UserController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $result = User::where('id_prefix', 'like', '%' . $value . '%')
            ->where('id_no', 'like', '%' . $value . '%')
            ->where('first_name', 'like', '%' . $value . '%')
            ->where('middle_name', 'like', '%' . $value . '%')
            ->where('last_name', 'like', '%' . $value . '%')
            ->where('suffix', 'like', '%' . $value . '%')
            ->where('department', 'like', '%' . $value . '%')
            ->where('position', 'like', '%' . $value . '%')
            ->where('permissions', 'like', '%' . $value . '%')
            ->where('document_types', 'like', '%' . $value . '%')
            ->where('categories', 'like', '%' . $value . '%')
            ->where('username', 'like', '%' . $value . '%')
            ->where('is_active', 'like', '%' . $value . '%')
            ->get();
