                ...
                foreach($document_types as $specific_document_type){
                    ...
                    if($specific_document_type['document_id']  == $specific_additional_document_id){
                        ...
                        if(isset($document_type)){
                            if(isset($document_type['categories'])){
                                // print_r($document_type['categories']);
                                if(!empty($document_type['categories'])){
                                    foreach($document_type['categories'] as $specific_category_id){

                                    echo $id.' - '.$document_type['id'].' - '.$specific_category_id.'____';
                                    GenericMethod::addToUserDocumentCategory($id,$specifidocument_type['id']c_document_id,$specific_category_id);
                                    }
                                }else{
                                    echo $id.' - '.$document_type['id'].' - 0____';
                                }
            ...
            if(isset($additional_category_ids)){
                foreach($additional_category_ids as $specific_category_id){
                    if($specific_category_id != 0){
                        return GenericMethod::addToUserDocumentCategory($id,$specific_document_id,$specific_category_id);
                    }
                }
