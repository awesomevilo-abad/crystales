...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($document_categories as $specific_document_categories) {
            ...
            $created_document_categories->push(['document_id'=>$specific_document_categories[0],'categpry_id'=>$specific_document_categories[0]]);
            echo ;
            echo $specific_document_categories[1];
            // foreach ($specific_document_categories[0] as $doc_id) {
            //     echo $doc_id;
            // }
        }
