...
//
            echo $final_specific_document_details_with_category ->masterlist_document_id.'=='.$final_specific_document_details_with_category ->masterlist_document_id.'________';

            // if($final_specific_document_details_with_category ->masterlist_document_id == $final_specific_document_details_with_category->masterlist_document_id){
                $document_status = true;
                foreach($categories as $specific_categories){
                    if($specific_categories['document_id'] == $final_specific_document_details_with_category ->masterlist_document_id){
