...
class TransactionController extends Controller
{
    ...
    public function status_group(Request $request)
    {
        ...
        $fullname = GenericMethod::getFullname($specific_status_group[0]->first_name,$specific_status_group[0]->middle_name,$specific_status_group[0]->last_name,$specific_status_group[0]-suffix);
        return $fullname;
        $result->push([
