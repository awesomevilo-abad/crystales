...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($fields['supplier_type_id'] as $inputed_supplier_type) {
            $supplier_type_ids = $supplier_types->pluck('id');

            if ($supplier_type_ids->contains($inputed_supplier_type)) {

            } else {
                array_push($unregistered_supplier_type_id, $inputed_supplier_type);
            }
        }

        print_r($unregistered_supplier_type_id)
        ...
        //     echo $unregistered_referrence_compiled . ' is not existing in the referrences table or disabled';
        // } else {
