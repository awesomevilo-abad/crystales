...
class SupplierTypeController extends Controller
{
    ...
    {
        $specific_supplier_type = Supplier_type::find($id);

        if (!$specific_supplier_type) {
            return "No Data Found";
        }

        $specific_supplier_type->supplier_type_code = $request->get('supplier_type_code');
        $specific_supplier_type->supplier_type_description = $request->get('supplier_type_description');
