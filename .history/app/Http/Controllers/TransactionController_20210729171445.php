...
class TransactionController extends Controller
{
    ...
    public function status_group($id){
        $status_group = DB::select(DB::raw('SELECT * FROM `transactions` LEFT JOIN taggings ON transactions.transaction_id=taggings.transaction_id LEFT JOIN gases ON transactions.tag_id=gases.tag_id LEFT JOIN filings ON transactions.tag_id=filings.tag_id
