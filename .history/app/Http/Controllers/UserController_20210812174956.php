...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        WHERE user_document_category.is_active = 1 AND users.is_active = 1 AND document_categories.is_active = 1 AND documents.is_active = 1 AND categories.is_active = 1
