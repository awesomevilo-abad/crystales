...
class TransactionController extends Controller
{
    ...
    public function index()
    {
         ...
         ,'t.status'
         ,'t.remarks')
        ->leftJoin('p_o_group_batches as PGB','t.tag_id','=','PGB.tag_id')
        ->leftJoin('p_o_batches as PB','PGB.po_no','=','PB.po_no')
        ->leftJoin('referrence_group_batches as RGB','t.tag_id','=','RGB.tag_id')
        ->leftJoin('referrence_batches as RB','RGB.referrence_no','=','RB.referrence_no')
        ->get();
        ...
        foreach($transactions as $transaction){
            ...
            $result->push(
                ...
                'ref_total_amount'=>$transaction->referrence_total_amount,
