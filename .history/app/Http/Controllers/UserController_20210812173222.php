...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        function unique_values_based_on_key($array, $key) {
            $temp_array = array();
            $i = 0;
            $key_array = array();
        ...
        print_r(unique_values_based_on_key($document_details,'masterlist_document_id'));

        foreach($document_details as $specific_document_details){
            // print_r($specific_document_details);
            ...
            //         if($specific_categories['document_id'] == $specific_document_details->user_document_id){
            ...
            // $document_types->push([
            //     "document_id"=>$specific_document_details->masterlist_document_id,
            //     "document_name"=>$specific_document_details->document_name,
        ...
        // $document_types = array_values($document_types);
        // return $categories;
