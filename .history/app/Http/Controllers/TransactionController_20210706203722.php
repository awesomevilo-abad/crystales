...
class TransactionController extends Controller
{
    ...
    public function validateExistingTransaction(
        $supplier_id,$po_no,$document_type,$payment_type,
        $document_no,$document_date,$document_amount,$company,$supplier
        ...
        if ($this->documentCount($fields['document_id']) < 1) {
            ...
            if(($fields['document_id'] == 3 || $fields['document_type'] == "PAD") && (empty($fields['po_group']))){
                ...
                for($i=0;$i<$po_count;$i++){
                    ...
                    if ($this->validateExistingTransaction($fields['supplier_id'],$po_no) > 0){
                        $response = [
                            "code" => 403,
