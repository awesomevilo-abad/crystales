...
class TransactionController extends Controller
{
    ...
    public function index()
    {
         ...
         ,'t.status'
         ,'t.remarks')
        ->join('p_o_group_batches as PGB','t.tag_id','=','PGB.tag_id')
        ->join('p_o_batches as PB','PGB.po_no','=','PB.po_no')
        ->join('referrence_group_batches as RGB','t.tag_id','=','RGB.tag_id')
        ->join('referrence_batches as RB','RGB.referrence_no','=','RB.referrence_no')
        ->get();
