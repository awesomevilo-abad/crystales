...
class DocumentController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($category_ids as $specific_document) {
            ...
            $document_details['document_id'] = $document_details_array[0]->id;
            $document_details['document_type'] = $document_details_array[0]->document_type;
            $document_details['document_description'] = $document_details_array[0]->document_description;
            $document_details['is_active'] = $document_details_array[0]->is_active;
