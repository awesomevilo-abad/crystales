...
use App\Models\ReferrenceBatches;
...
// ---------------------------------------------------
            ...
            for($i=0;$i<$ref_count;$i++){
                ...
                $referrence_qty =  $ref_object->referrence_no;
                $referrence_qty =  $ref_object->referrence_qty;
                ...
                $insert_referrence_batch = ReferrenceBatches::create([
            ...
            //     , "referrence_total_amount" => $request['referrence_group']
            //     , "referrence_total_qty" => $request['referrence_group']
            //     , "tag_id" => $tag_id
