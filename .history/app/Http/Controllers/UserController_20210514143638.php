...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ___________DOCUMENT CATEGORY___________
        ...
        foreach ($document_ids as $specific_doc_id) {
            ...
            array_push($created_document_categories, array("categories" => $categories, "document_id" => $specific_doc_id));
            $fields['document_types'] = $created_document_categories;
        }

        // return $fields['document_types'];
