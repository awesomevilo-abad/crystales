...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $user_document_details->push([
            ...
            "role"=> $user_details->id_prefix,
            "first_name"=> $user_details->id_prefix,
            "middle_name"=> $user_details->id_prefix,
            "last_name"=> $user_details->id_prefix,
            "suffix"=> null,
            "department"=> $user_details->id_prefix,
            "position"=> $user_details->id_prefix,
            "permissions"=> [
            "AP Tagging"
            ],
            "document_types"=> [],
