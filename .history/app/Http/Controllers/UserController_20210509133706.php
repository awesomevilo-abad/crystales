...
class UserController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $result = User::where('id_prefix', 'like', '%' . $id_prefix . '%')
            ->orWhere('id_no', 'like', '%' . $id_no . '%')
            ->orWhere('first_name', 'like', '%' . $first_name . '%')
            ->orWhere('middle_name', 'like', '%' . $middle_name . '%')
            ->orWhere('last_name', 'like', '%' . $last_name . '%')
            ->orWhere('suffix', 'like', '%' . $suffix . '%')
            ->orWhere('department', 'like', '%' . $department . '%')
            ->orWhere('position', 'like', '%' . $position . '%')
            ->orWhere('permissions', 'like', '%' . $permissions . '%')
            ->orWhere('document_types', 'like', '%' . $document_types . '%')
            ->orWhere('categories', 'like', '%' . $categories . '%')
            ->orWhere('username', 'like', '%' . $username . '%')
            ->orWhere('is_active', 'like', '%' . $is_active . '%')
            ->pluck('user_id');
