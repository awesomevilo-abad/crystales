            ...
            if(!empty($po) || isset($po)){
                ...
                for($i=0;$i<$po_validation_count;$i++){
                    ...
                    if(!empty($referrence_group) || isset($referrence_group)){
                        ...
                        TransactionValidationMethod::validateExistingPRMTransaction();
                    }else{
                        TransactionValidationMethod::validateExistingPRMTransactionWithoutReferrence($fields['company_id'],$fields['supplier_id'],$fields['company_id']);
                    }
