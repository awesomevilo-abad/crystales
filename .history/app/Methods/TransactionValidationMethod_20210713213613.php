                ...
                if((!empty($po)) && ((empty($referrence_group) )) ){
                    ...
                    // IF ISSET Means Need additional PO because Document Amount is higher than PO Amount
                     if(isset($used_po)){
                        ...
                        echo  $balance_document_po_amount = GenericMethod::getBalanceAmountOfDocumentPO($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount'],$fields['balance_document_po_amount']);
                    }
