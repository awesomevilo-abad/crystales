            ...
            if($fields['payment_type'] == 'FULL'){
                ...
                if((!empty($po)) && ((empty($referrence_group) )) ){
                    ...
                    for($i=0;$i<$po_validation_count;$i++){
                        ...
                        if ($get_tag_id = GenericMethod::getTagIDUsingPONo($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount']) > 0){
                            $tag_id[] =  $po_no;
                        }

                        if (GenericMethod::validateIfPOExistInOtherDocNo($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no) > 0){
                    ...
                    // return $count_of_po_in_other_doc;
                        ...
                        if(isset($used_po)){
                            ...
                            // return end($used_po);
                                ...
                                // return $balance_document_po_amount_object[0]->balance_document_po_amount;
                        ...
                        // TRAPPING FOR DUPLICATE PARTIAL PRM

                        // if($count_of_po_in_other_doc > 0){
                        //     $response = [
                        //         "code" => 403,
                        //         "message" => "PO No Already Exist in different Document, Payment Type and Document No.",
                        //             "data" => null,
                        //     ];
                        // }else{
                            if($response == "Validated"){
