                     ...
                     if(isset($used_po)){
                        ...
                        if($po_list){
                            ...
                            for($i=0;$i<$po_list_count;$i++){
                                ...
                                $po_validation_total_qty = $po_validation_total_qty+$po_list[$i]->po_qty;
                        ...
                        if($response == "Validated"){
                            ...
                            $response =  $balance_document_po_amount.'_'.$po_validation_total_amount.'_'.$fields['document_amount'];
