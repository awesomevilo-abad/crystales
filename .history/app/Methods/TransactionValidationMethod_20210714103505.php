            ...
            if($fields['payment_type'] == 'FULL'){
                ...
                if((!empty($po)) && ((empty($referrence_group) )) ){
                    ...
                    for($i=0;$i<$po_validation_count;$i++){
                        ...
                        $balance_document_po_amount = GenericMethod::($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount'],$balance_document_po_amount);
