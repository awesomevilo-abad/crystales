                ...
                if(!empty($po) || isset($po)){
                  ...
                  // Compile existed PO Number
                    if(isset($duplicate_po_array)){
                        ...
                        if(isset($po_validation_total_amount) || !empty($po_validation_total_amount)){
                            if($fields['document_amount'] < $po_validation_total_amount){
                                $validation_response =  [
                                    "code" => 400,
                            ...
                            }else ($fields['document_amount'] > $po_validation_total_amount){
                                $validation_response =  [
                                    "code" => 400,
                        ...
                        }else if(isset($ref_validation_total_amount) || !empty($ref_validation_total_amount)){
                            ...
                            $validation_response = 'Validated INSERT FORMULA HERE';
                        }
