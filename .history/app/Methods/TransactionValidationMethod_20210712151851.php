                    ...
                    // $response = 'REFERRENCE FULL';
                        ...
                        if($fields['document_amount'] < $ref_validation_total_amount){
                            ...
                            for($i=0;$i<$ref_count;$i++){
                                ...
                                $ref_amount =(float) str_replace(',', '', $po_object->po_amount);
                                $ref_qty =(float) str_replace(',', '', $po_object->po_qty);
                                $ref_total_amount = $po_total_amount+$po_amount;
                                $ref_total_qty = $po_total_qty+$po_qty;
