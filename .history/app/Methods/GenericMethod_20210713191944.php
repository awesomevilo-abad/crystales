    ...
    public static function getBalanceAmountOfDocumentPO($payment_type,$company_id,$supplier_id,$po_no,$document_amount,$balance_document_po_amount){
        ...
        $transactions;
         if($transactions->isEmpty()){
            $transactions  = $fields['balance_document_po_amount'];
        }
        else{

            $transactions = $balance_document_po_amount[0]->balance_document_po_amount;
            $transactions = $balance_document_po_amount - $fields['document_amount'];
        }
