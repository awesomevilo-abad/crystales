                    ...
                    // IF ISSET Means Need additional PO because Document Amount is higher than PO Amount
                     if(isset($used_po)){
                        ...
                        if($po_list){
                            ...
                            GenericMethod::validateIfDocumentAmountIsGreaterThanPO($po_total_amount,$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount'],$fields['balance_document_po_amount']);
