        ...
        if (GenericMethod::validateIfDocumentNoExist($fields['document_no']) > 0){
            ...
            if($fields['payment_type'] == 'FULL'){
                ...
                if((!empty($po)) && ((empty($referrence_group) )) ){
                    ...
                    // KAPAG WALANG used_po Ibig sabihin new PO ang prinoprocess
                    ...
                    // return $po_list;
                        ...
                        if($po_list){
                            ...
                            if($balance_document_po_amount_object->isEmpty()){
                                ...
                                $balance_document_po_amount = $fields['document_amount'] - $balance_document_po_amount;
                            }
                            ...
                            return $po_validation_total_amount;
