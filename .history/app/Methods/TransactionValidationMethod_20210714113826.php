                    ...
                    // IF ISSET Means Need additional PO because Document Amount is higher than PO Amount
                     if(isset($used_po)){
                        ...
                        if($po_list){
                            ...
                            $balance_document_po_amount = GenericMethod::getBalanceAmountOfDocumentPO($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],end($used_po),$fields['document_amount'],$balance_document_po_amount);


         if($transactions->isEmpty()){
            $transactions  = $balance_document_po_amount;
        }
        else{

            $transactions = $transactions[0]->balance_document_po_amount;
            $transactions = $transactions - $document_amount;
        }
