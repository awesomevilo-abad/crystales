        ...
        if(isset($fields['document_no'])){
            ...
            if (GenericMethod::validateIfDocumentNoExist($fields['document_no']) > 0){
                ...
                for($i=0;$i<$po_validation_count;$i++){
                    ...
                    if (GenericMethod::validateIfPONoExist($fields['company_id'],$fields['company_id'],$fields['supplier_id'],$po_no) > 0){
                ...
                for($i=0;$i<$po_validation_count;$i++){
                    ...
                    if(!empty($referrence_group) || isset($referrence_group)){
                        ...
                        for($i=0;$i<$ref_validation_count;$i++){
                            ...
                            if (GenericMethod::validateIfRefNoExist($fields['company_id'],$fields['supplier_id'],$ref_no) > 0){
                        ...
                        if (GenericMethod::validateIfPONoExist($fields['company_id'],$fields['supplier_id'],$po_no) > 0){
                            $duplicate_po_array[] =  $po_no;
                        }else if (GenericMethod::validateIfPONoExistInDifferentSupplier($fields['company_id'],$fields['supplier_id'],$po_no) > 0){
                            $duplicate_ref_array[] =  $ref_no;
                        }
