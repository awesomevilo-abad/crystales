...
class GenericMethod{
    ...
    public static function getBalanceAmountOfDocumentPO($payment_type,$company_id,$supplier_id,$po_no,$document_amount,$balance_document_po_amount){
        $transactions = DB::table('transactions')
        ->leftJoin('p_o_batches','transactions.tag_id','=','p_o_batches.tag_id')
        ...
        ->orderBy('transactions.balance_document_po_amount','desc')
        ->take(1)
    ...
    public static function validateIfPartialPONoExistInPRM($payment_type,$company_id,$supplier_id,$po_no,$document_amount){
        $transactions = DB::table('transactions')
        ->leftJoin('p_o_batches','transactions.tag_id','=','p_o_batches.tag_id')
        ->where('payment_type',$payment_type)
        ->where('company_id',$company_id)
    ...
    public static function validateIfDocumentAmountIsGreaterThanPO($po_total_amount,$document_amount){
