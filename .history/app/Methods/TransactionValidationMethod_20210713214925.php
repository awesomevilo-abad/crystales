                ...
                if((!empty($po)) && ((empty($referrence_group) )) ){
                    ...
                    // IF ISSET Means Need additional PO because Document Amount is higher than PO Amount
                     if(isset($used_po)){
                        ...
                        // po_list is the compilation of additional POs
                        ...
                        if($po_list){
                            ...
                            $balance_document_po_amount = GenericMethod::getBalanceAmountOfDocumentPO($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount'],$fields['balance_document_po_amount']);
                            $po_total_amount = $po_list_total_amount + $balance_document_po_amount;

                            // PO TOTAL AMOUNT - DOCUMENT AMOUNT TO GET THE NEW DOC PO BALANCE
                            $balance_document_po_amount = $po_total_amount - $fields['document_amount'];
                            
                            
                            $response = GenericMethod::validateIfDocumentAmountIsGreaterThanPO($po_total_amount,$po_no,$fields['document_amount'],$po_additional_pos);
                   
                        }else{
                            $response = [
                                "code" => 403,
                                "message" => "Document Amount is Higher than the Balance",
                                    "data" => $used_po,
                            ];
                        ...
                        $response =  "Insert No Additional PO";

                        $response = GenericMethod::validateIfDocumentAmountIsGreaterThanPO($po_validation_total_amount,$po_no,$fields['document_amount'],$po_additional_pos);
                        $balance_document_po_amount = GenericMethod::getBalanceAmountOfDocumentPO($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount'],$fields['balance_document_po_amount']);
                        
                        // echo $fields['document_amount'].'_'.$fields['balance_document_po_amount'];
                    }

                        // $response =  $balance_document_po_amount;
