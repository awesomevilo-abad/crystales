                ...
                if((!empty($po)) && ((empty($referrence_group) )) ){
                    ...
                    for($i=0;$i<$po_validation_count;$i++){
                        ...
                        $po_no_list[] =  $po_validation_object->po_no;
                         ...
                         rechoeturn GenericMethod::validateIfPartialPONoExistInPRM($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount']);

                    }

                    // $balance_document_po_amount = GenericMethod::getBalanceAmountOfDocumentPO($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount'],$balance_document_po_amount);
                    ...
                    // IF ISSET Means Need additional PO because Document Amount is higher than PO Amount
                     if(isset($used_po)){
                        ...
                        //         $balance_document_po_amount_object  = $balance_document_po_amount;
                        //     }
                        //     else{

                        //         $balance_document_po_amount_object = $balance_document_po_amount_object[0]->balance_document_po_amount;
                        //         $balance_document_po_amount_object = $balance_document_po_amount_object - $document_amount;
                        //     }

                        //     $po_validation_total_amount = $po_list_total_amount + $balance_document_po_amount;
