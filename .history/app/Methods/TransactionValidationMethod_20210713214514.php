                    ...
                    // IF ISSET Means Need additional PO because Document Amount is higher than PO Amount
                     if(isset($used_po)){
                        ...
                        if($po_list){
                            ...
                            GenericMethod::validateIfDocumentAmountIsGreaterThanPO($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no,$fields['document_amount'],$fields['balance_document_po_amount']);
                            // if ($po_total_amount < $fields['document_amount']){
                            //     $response = [
                            //         "code" => 403,
