                ...
                if((!empty($po)) && ((empty($referrence_group) )) ){
                    ...
                    for($i=0;$i<$po_validation_count;$i++){
                        ...
                        $po_validation_total_qty = $po_validation_total_qty+$po_validation_qty;
                         ...
                         $historical_transaction =  GenericMethod::getBalanceAmountOfDocumentPO($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no);
                         $balance_document_po_amount = $historical_transaction[0]->balance_document_po_amount;
                         foreach($historical_transaction as $specific_historical_transaction){
                             $balance_document_po_amount = $specific_historical_transaction->balance_document_po_amount;
                         }
                         if($balance_document_po_amount > 0){
                             if($balance_document_po_amount > $fields['document_amount']){
                                $response =  'Insert';
                             }else{
                                $response =  [
                                    "code" => 400,
