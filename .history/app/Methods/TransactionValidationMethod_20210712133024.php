    ...
    if(isset($fields['document_no'])){
        ...
        if (GenericMethod::validateIfDocumentNoExist($fields['document_no']) > 0){
            ...
            if($fields['payment_type'] == 'FULL'){
                ...
                if((!empty($po) || isset($po)) && ((empty($referrence_group) || (isset($referrence_group)))) ){
                    ...
                    if(isset($duplicate_po_array)){
                        ...
                        if(isset($fields['po_group'])){
                            if($fields['document_amount'] < $po_validation_total_amount){
                                ...
                                $po_response = 'Validated';
                            }
                        }

                         if((isset($fields['referrence_group'])) || (!empty($fields['referrence_group']))){
                            if($fields['document_amount'] < $ref_validation_total_amount){
                                ...
                                $ref_response = 'Validated';
                            }
                        }

                        if($po_response != 'Validated' ){
                            $response = $po_response;
                        }else if($ref_response != 'Validated' ){
                            $response = $ref_response;
                        }else if(($po_response != 'Validated') && ($ref_response != 'Validated') ){
                            $response =  [
                                "code" => 400,
                                "message" => "PO Amount and Ref Amount are not equal to the Document Amount",
                                "data" => null,
                            ];
                        }else{
                            $response = 'INSERt PO Insert Here Validated';
                        }
                    }
